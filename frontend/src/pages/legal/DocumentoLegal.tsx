...
/**
 * A casca comum dos documentos legais — Política de Privacidade e Termos de
 * Uso —, renderizados do markdown versionado em `src/content/`.
 *
 * O texto vive num arquivo e não no componente de propósito: cada revisão
...
export function DocumentoLegal({ conteudo }: { conteudo: string }) {
  ...
  /**
   * Todo link para estas páginas abre em ABA NOVA (cadastro, login, rodapé), e
