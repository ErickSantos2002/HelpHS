  ...
  return (
    <div className="space-y-5">
          ...
          <button
            ...
            className={cn(
              ...
              unreadOnly === tab.value
                ...
                : "text-slate-500 dark:text-slate-400 hover:bg-surface-elevated hover:text-slate-900 dark:hover:text-slate-100",
            )}
          >
            {tab.label}
            {tab.value && unread > 0 && (
      ...
      {loading ? (
        ...
        <div className="rounded-xl bg-surface border border-borda overflow-hidden divide-y divide-slate-100 dark:divide-borda/60">
          {items.map((n) => {
